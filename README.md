...
missing evidence for that historical release. Beta 9 retains the mandatory
...
`v1.0.0-beta.9` commit. Its product version and publication-clearance hashes
...
not selected for Beta 9. This release therefore makes no tested-
generation support claim for Apple devices and no independent-review
qualification claim. Safari Lockdown Mode and managed
configurations that disable Web Locks are outside the Beta 9 support claim:
