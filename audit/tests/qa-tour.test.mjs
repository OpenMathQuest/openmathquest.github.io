...
function qaReportHarness({
  ...
  const source = `(()=>{"use strict";
    const QA_TOUR_VERSION="qa-tour-v1",QA_TOUR_SEED=0x51415431,QA_TOUR_V1=effects.specs,KEY="math-quest:v1",PWA_RELEASE="1.0.0-beta.5",PWA_BUILD_ID="math-quest-pwa-v1.0.0-beta.5";
