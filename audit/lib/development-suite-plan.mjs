...
const ROUTES = Object.freeze({
  "art-design": [/^(?:audit\.html|index\.html|release-shell-v1\.json)$/u, /^assets\/design\//u, /^audit\/(?:art-asset-register-v1|art-design-decision-register-v1|art-migration-baseline-v1|art-migration-browser-evidence-v1)\.json$/u, /^audit\/schemas\/(?:art-asset-register-v1|art-design-decision-register-v1|art-migration-baseline-v1|art-migration-browser-evidence-v1|design-tokens-v1)\.schema\.json$/u, /^audit\/lib\/(?:art-design-governance|art-migration-baseline|art-question-shell|design-token-projection|engine-loader)\.mjs$/u, /^audit\/tests\/(?:art-design-governance|art-migration-baseline|art-question-shell|design-token-projection)\.test\.mjs$/u, /^audit\/validate-art-migration-baseline\.mjs$/u, /^curriculum\/(?:math-quest-feature-map-v1|math-quest-tutorial-manifest-v1)\.json$/u, /^licenses\/(?:component-register-v1|evidence-paths-v1)\.json$/u, /^tools\/build-design-token-projection\.mjs$/u],
  ...
  pwa: [/^(?:VERSION|audit\.html|index\.html|sw\.js|manifest\.webmanifest|release-shell-v1\.json)$/u, /^curriculum\/math-quest-tutorial-manifest-v1\.json$/u, /^assets\//u, /^tools\/build-pwa-release-manifest\.mjs$/u, /^audit\/(?:lib\/browser-smoke|run-browser-smoke)\.mjs$/u, /^audit\/tests\/pwa-release\.test\.mjs$/u, /^\.github\/workflows\/(?:pages|audit)\.yml$/u],
  canary: [/^VERSION$/u, /^audit\/(?:trusted-https-canary-v1\.json|run-trusted-https-canary\.(?:mjs|ps1)|validate-trusted-https-canary\.mjs)$/u, /^audit\/lib\/trusted-https-canary(?:-supply-chain)?\.mjs$/u, /^audit\/tests\/trusted-https-canary\.test\.mjs$/u, /^\.github\/workflows\/trusted-https-canary\.yml$/u, /^(?:package|package-lock)\.json$/u, /^licenses\/ci-toolchain\.md$/u],
  ...
  driftless: [/^(?:AGENTS\.md|VERSION|audit\.html|index\.html|release-shell-v1\.json)$/u, /^audit\/(?:art-asset-register-v1|art-design-decision-register-v1|art-migration-baseline-v1|art-migration-browser-evidence-v1|gate-integrity-policy-v1|release-evidence-bundle-v1|repository-code-map-v1|trusted-https-canary-beta7-v1|trusted-https-canary-v1)\.json$/u, /^audit\/(?:compare-audit-execution-modes|run-audit(?:-lane)?|validate-art-migration-baseline|verify-github-gate-enforcement)\.(?:mjs|ps1)$/u, /^curriculum\/(?:math-quest-manifest-v1|math-quest-tutorial-manifest-v1|math-quest-feature-map-v1)\.json$/u, /^assets\/design\/math-quest-design-tokens-v1\.(?:css|json)$/u, /^licenses\/(?:component-register-v1|evidence-paths-v1)\.json$/u, /^audit\/schemas\/(?:art-asset-register-v1|art-design-decision-register-v1|art-migration-baseline-v1|art-migration-browser-evidence-v1|blast-radius-result-v2|design-tokens-v1|gate-integrity-policy-v1|release-evidence-bundle-v1|repository-code-map-v1|tutorial-manifest-v1|feature-map-v1)\.schema\.json$/u, /^audit\/lib\/(?:art-design-governance|art-migration-baseline|art-question-shell|bounded-audit-lanes|design-token-projection|gate-integrity-policy|release-evidence-bundle|repository-code-map|tutorial-manifest|feature-map|development-suite-plan)\.mjs$/u, /^audit\/tests\/(?:art-design-governance|art-migration-baseline|art-question-shell|design-token-projection|gate-integrity-policy|release-evidence-bundle|repository-code-map|tutorial-manifest|feature-map|blast-radius-lookup|development-suite-plan|audit-lane-orchestration|audit-orchestration)\.test\.mjs$/u, /^tools\/(?:blast-radius-lookup|build-design-token-projection|sync-repository-code-map|build-tutorial-manifest|sync-tutorial-manifest)\.mjs$/u],
