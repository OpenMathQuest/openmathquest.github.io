...
const ROUTES = Object.freeze({
  "art-design": [/^(?:index\.html|release-shell-v1\.json)$/u, /^assets\/design\//u, /^audit\/(?:art-asset-register-v1|art-design-decision-register-v1)\.json$/u, /^audit\/schemas\/(?:art-asset-register-v1|art-design-decision-register-v1|design-tokens-v1)\.schema\.json$/u, /^audit\/lib\/art-design-governance\.mjs$/u, /^audit\/tests\/art-design-governance\.test\.mjs$/u, /^curriculum\/(?:math-quest-feature-map-v1|math-quest-tutorial-manifest-v1)\.json$/u, /^licenses\/(?:component-register-v1|evidence-paths-v1)\.json$/u],
  ...
  driftless: [/^(?:AGENTS\.md|VERSION|index\.html|release-shell-v1\.json)$/u, /^audit\/(?:art-asset-register-v1|art-design-decision-register-v1|gate-integrity-policy-v1|release-evidence-bundle-v1|repository-code-map-v1|trusted-https-canary-beta7-v1)\.json$/u, /^audit\/(?:compare-audit-execution-modes|run-audit(?:-lane)?|verify-github-gate-enforcement)\.(?:mjs|ps1)$/u, /^curriculum\/(?:math-quest-manifest-v1|math-quest-tutorial-manifest-v1|math-quest-feature-map-v1)\.json$/u, /^assets\/design\/math-quest-design-tokens-v1\.json$/u, /^licenses\/(?:component-register-v1|evidence-paths-v1)\.json$/u, /^audit\/schemas\/(?:art-asset-register-v1|art-design-decision-register-v1|blast-radius-result-v2|design-tokens-v1|gate-integrity-policy-v1|release-evidence-bundle-v1|repository-code-map-v1|tutorial-manifest-v1|feature-map-v1)\.schema\.json$/u, /^audit\/lib\/(?:art-design-governance|bounded-audit-lanes|gate-integrity-policy|release-evidence-bundle|repository-code-map|tutorial-manifest|feature-map|development-suite-plan)\.mjs$/u, /^audit\/tests\/(?:art-design-governance|gate-integrity-policy|release-evidence-bundle|repository-code-map|tutorial-manifest|feature-map|blast-radius-lookup|development-suite-plan|audit-lane-orchestration|audit-orchestration)\.test\.mjs$/u, /^tools\/(?:blast-radius-lookup|sync-repository-code-map|build-tutorial-manifest|sync-tutorial-manifest)\.mjs$/u],
