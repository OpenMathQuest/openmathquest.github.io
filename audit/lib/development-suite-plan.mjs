...
const ROUTES = Object.freeze({
  ...
  driftless: [/^(?:AGENTS\.md|VERSION|index\.html)$/u, /^audit\/(?:repository-code-map-v1\.json|run-audit\.(?:mjs|ps1))$/u, /^curriculum\/(?:math-quest-manifest-v1|math-quest-tutorial-manifest-v1|math-quest-feature-map-v1)\.json$/u, /^audit\/schemas\/(?:blast-radius-result-v2|repository-code-map-v1|tutorial-manifest-v1|feature-map-v1)\.schema\.json$/u, /^audit\/lib\/(?:repository-code-map|tutorial-manifest|feature-map|development-suite-plan)\.mjs$/u, /^audit\/tests\/(?:repository-code-map|tutorial-manifest|feature-map|blast-radius-lookup|development-suite-plan|audit-orchestration)\.test\.mjs$/u, /^tools\/(?:blast-radius-lookup|sync-repository-code-map|build-tutorial-manifest|sync-tutorial-manifest)\.mjs$/u],
