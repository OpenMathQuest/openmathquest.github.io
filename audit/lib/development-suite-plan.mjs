...
const ROUTES = Object.freeze({
  ...
  driftless: [/^(?:AGENTS\.md|VERSION|index\.html)$/u, /^audit\/(?:gate-integrity-policy-v1|release-evidence-bundle-v1|repository-code-map-v1|trusted-https-canary-beta7-v1)\.json$/u, /^audit\/(?:run-audit|verify-github-gate-enforcement)\.(?:mjs|ps1)$/u, /^curriculum\/(?:math-quest-manifest-v1|math-quest-tutorial-manifest-v1|math-quest-feature-map-v1)\.json$/u, /^audit\/schemas\/(?:blast-radius-result-v2|gate-integrity-policy-v1|release-evidence-bundle-v1|repository-code-map-v1|tutorial-manifest-v1|feature-map-v1)\.schema\.json$/u, /^audit\/lib\/(?:gate-integrity-policy|release-evidence-bundle|repository-code-map|tutorial-manifest|feature-map|development-suite-plan)\.mjs$/u, /^audit\/tests\/(?:gate-integrity-policy|release-evidence-bundle|repository-code-map|tutorial-manifest|feature-map|blast-radius-lookup|development-suite-plan|audit-orchestration)\.test\.mjs$/u, /^tools\/(?:blast-radius-lookup|sync-repository-code-map|build-tutorial-manifest|sync-tutorial-manifest)\.mjs$/u],
  playwright: [/^(?:VERSION|index\.html|Serve-MathQuest\.ps1|playwright(?:\.deep-ux)?\.config\.mjs|package\.json|package-lock\.json)$/u, /^assets\//u, /^audit\/playwright\//u, /^audit\/run-playwright-(?:focused|deep-ux-census)\.mjs$/u, /^audit\/lib\/playwright-(?:focused-contract|deep-ux-census)\.mjs$/u, /^audit\/tests\/playwright-(?:focused-contract|deep-ux-census)\.test\.mjs$/u],
  governance: [/^(?:AGENTS|CHANGELOG|CONTRIBUTING|OPEN_SOURCE_POLICY|PRIVACY|PUBLICATION_CLEARANCE|README|SECURITY|THIRD_PARTY_NOTICES)\.md$/u, /^(?:LICENSE|VERSION)$/u, /^audit\/(?:agent-collaboration-policy-v1|certification-cadence-v1|finished-work-policy-v1|browser-runner-evidence-v1|gate-integrity-policy-v1|release-evidence-bundle-v1|trusted-https-canary-beta7-v1)\.json$/u, /^audit\/schemas\/(?:gate-integrity-policy-v1|release-evidence-bundle-v1)\.schema\.json$/u, /^audit\/tests\/(?:agent-collaboration-policy|audit-orchestration|certification-cadence|development-suite-plan|finished-work-policy|gate-integrity-policy|publication-clearance|release-evidence-bundle)\.test\.mjs$/u, /^audit\/lib\/(?:browser-runner-evidence|development-suite-plan|gate-integrity-policy|publication-clearance|release-evidence-bundle|release-evidence-successor|rights-state|hosted-windows-observation)\.mjs$/u, /^audit\/(?:public-candidate-guard|validate-publication-clearance|validate-hosted-windows-observation|verify-github-gate-enforcement)\.mjs$/u, /^audit\/(?:observe-hosted-windows|run-audit|on-change-audit)\.ps1$/u, /^audit\/run-audit\.mjs$/u, /^\.github\/workflows\//u, /^docs\//u, /^research\//u, /^licenses\//u, /^VERSION$/u],
});
