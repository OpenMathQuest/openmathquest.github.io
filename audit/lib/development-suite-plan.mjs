...
const ROUTES = Object.freeze({
  "art-design": [/^(?:audit\.html|index\.html|release-shell-v1\.json)$/u, /^assets\/design\//u, /^audit\/(?:art-asset-register-v1|art-design-decision-register-v1|art-migration-baseline-v1|art-migration-browser-evidence-v1)\.json$/u, /^audit\/schemas\/(?:art-asset-register-v1|art-design-decision-register-v1|art-migration-baseline-v1|art-migration-browser-evidence-v1|design-tokens-v1)\.schema\.json$/u, /^audit\/lib\/(?:art-design-governance|art-migration-baseline|design-token-projection|engine-loader)\.mjs$/u, /^audit\/tests\/(?:art-design-governance|art-migration-baseline|design-token-projection)\.test\.mjs$/u, /^audit\/validate-art-migration-baseline\.mjs$/u, /^curriculum\/(?:math-quest-feature-map-v1|math-quest-tutorial-manifest-v1)\.json$/u, /^licenses\/(?:component-register-v1|evidence-paths-v1)\.json$/u, /^tools\/build-design-token-projection\.mjs$/u],
