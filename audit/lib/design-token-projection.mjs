...
export function expectedDesignTokenProjection(tokens) {
  ...
  return Object.freeze({
    ...
    renderedChangePolicy: "FUNCTIONAL_ART_QUESTION_SHELL_ZONES_EARLY_COUNTING_AND_EARLY_FRAME_ONLY_THROUGH_ART_MIG_06",
    activationGate: "EARLY_COUNTING_COUNT_TOUCH_AND_MQ_026_TEN_FRAME_PLAIN_BASELINES_AND_ORACLES_VERIFIED",
