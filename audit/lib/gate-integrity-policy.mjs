...
export async function validateGateIntegrityPolicy(policy, { root = repositoryRoot, trackedPaths = null } = {}) {
  ...
  const requiredFamilyIds = [
    "gate.art-design-governance", "gate.art-functional-vertical-slice", "gate.art-migration-baseline", "gate.art-token-projection", "gate.audit-orchestration", "gate.browser", "gate.canary", "gate.coverage", "gate.deep-ux", "gate.engine", "gate.generator",
