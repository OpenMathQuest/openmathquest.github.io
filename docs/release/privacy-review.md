...
This status is the Beta 9 preparation snapshot. Final exact-candidate scan and
publication status come from `PUBLICATION_CLEARANCE.md`,
`audit/release-evidence-bundle-v1.json`, and the bound certification artifacts.
The snapshot is retained unchanged in the frozen release tree.
...
historical Beta 4 disposition rather than a new Beta 9 privacy finding. The decision
...
explicit Beta 4 record and is not silently rewritten as a new Beta 9
...
For Beta 9, that exact digest-bound host state remains
